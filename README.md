...
| :--- | :--- | :--- |
| **Batch Insert (1M)** | **~746,268 ops/sec** | ~922,506 ops/sec |
| **Read (ID Lookup)** | **~917,431 ops/sec** | ~32,258,064 ops/sec |
| **Search (Indexed)** | **~134,336 ops/sec** | ~23,809,523 ops/sec |
| **Hash Join (100k)** | **~18.1 ops/sec** | ~73.7 ops/sec |
