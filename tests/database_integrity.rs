use dbobj::core::{Database, Schema, ColumnDefinition, DataType, RowData, Value, Expr, Operator};
...
fn test_database_crud_integrity() {
    ...
    let schema = Schema {
        columns: vec![
            ...
            ColumnDefinition { name: "age".into(), data_type: DataType::Integer, nullable: true },
        ],
    };
...
fn test_complex_query_integrity() {
    ...
    let schema = Schema {
        columns: vec![
            ColumnDefinition { name: "score".into(), data_type: DataType::Integer, nullable: false },
        ],
    };
...
fn test_join_integrity() {
    ...
    db.create_table("users".to_string(), Schema {
        columns: vec![
            ColumnDefinition { name: "uid".into(), data_type: DataType::Integer, nullable: false },
            ColumnDefinition { name: "name".into(), data_type: DataType::String, nullable: false },
        ],
    });
