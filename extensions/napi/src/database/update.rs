...
pub(crate) fn update_row_i64(db: &Database, table_name: String, id: u32, values: Vec<i64>) -> Result<(), napi::Error> {
...
pub(crate) fn update_row_string(db: &Database, table_name: String, id: u32, values: Vec<String>) -> Result<(), napi::Error> {
...
pub(crate) fn update_row_bool(db: &Database, table_name: String, id: u32, values: Vec<bool>) -> Result<(), napi::Error> {
...
pub(crate) fn update_row(db: &Database, table_name: String, id: u32, values: Vec<serde_json::Value>) -> Result<(), napi::Error> {
